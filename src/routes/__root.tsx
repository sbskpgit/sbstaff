...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Special Branch Sheikhupura — Staff Management" },
      { property: "og:description", content: "Manage Nafri records, transfers, postings and reports for Special Branch Sheikhupura Region." },
